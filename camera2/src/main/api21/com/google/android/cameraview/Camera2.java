...
class Camera2 extends CameraViewImpl {
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            if (data != null) {
                mCallback.onPictureTaken(data, reader.getWidth(), reader.getHeight());
            }
        }
    };
    ...
    private int mFlash = Constants.FLASH_OFF; //默认关闭
    ...
    @Override
    void takePreview() {//设置重复捕获会话请求，即开启预览模式(默认开启)
        try {
    ...
    private void initCallbackImageDataReader(int width, int height) {
        ...
        mCallbackImageDataReader = ImageReader.newInstance(width, height,
                ImageFormat.JPEG, /* maxImages */ 1);//ImageFormat.YV12
