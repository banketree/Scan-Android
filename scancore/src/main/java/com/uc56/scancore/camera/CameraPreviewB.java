...
public class CameraPreviewB extends CameraZoomPreview implements SurfaceHolder.Callback {
    ...
    public CameraPreviewB(Context context, Camera camera, Camera.PreviewCallback previewCallback) {
        super(context);
        init(camera, previewCallback);
    }

    public CameraPreviewB(Context context, AttributeSet attrs, Camera camera, Camera.PreviewCallback previewCallback) {
        super(context, attrs);
        init(camera, previewCallback);
    }
